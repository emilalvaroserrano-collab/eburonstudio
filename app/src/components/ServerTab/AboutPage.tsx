    ...
    <>
      ...
      <div className="max-w-md mx-auto h-full flex items-center">
        <div className="flex flex-col items-center text-center space-y-5">
          <FadeIn delay={0}>
            <img src={voiceboxLogo} alt="Eburon Studio" className="w-24 h-24 object-cover rounded-2xl shadow-lg border border-white/10" />
          </FadeIn>

          <FadeIn delay={80}>
            <div className="space-y-1.5">
              <h1 className="text-lg font-semibold">Eburon Studio</h1>
